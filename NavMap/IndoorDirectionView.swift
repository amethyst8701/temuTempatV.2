...
struct IndoorDirectionView: View {
    ...
    @State private var showingNavigationSteps = false
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $showingNavigationSteps) {
            if let location = selectedLocation {
                NavigationStepsView(
...
#Preview {
    IndoorDirectionView(destination: Place.greenEatery) { startingPoint in
        print("Selected: \(startingPoint)")
    }
}
